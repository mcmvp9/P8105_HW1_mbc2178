...
```
The first five observations show that this data include `r view(penguins)` .
In this dataset there are `r nrow(penguins)` observations (rows) and `r ncol(penguins)` variables (columns). 
